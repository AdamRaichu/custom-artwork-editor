export const painIconID = "adamraichu_custom-artwork-editor_paintIcon";
export const paintSvgPath = `<path d="M25,21v10H11v-4c0-0.276-0.224-0.5-0.5-0.5S10,26.724,10,27v4H9v-8c0-0.276-0.224-0.5-0.5-0.5
